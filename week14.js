...
const myFirstArray = [" Яблоко", 7, true]; // объявите переменную здесь
console.log(myFirstArray);

//Задание 2
//Создайте массив mySecondArray, заполните его любыми значениями. Выведите длину массива.
const mySecondArray = ['Книги', 'Кофе', 'Зефир'];// объявите переменную здесь
...
const myInformation = ['София', '1', 'октября', 'Весы'];
const myInformationResult = myInformation.join(' ');
console.log(myInformationResult);
...
let newRussianCities = ['Санкт-Петербург', 'Москва', 'Екатеринбург'];
let resultCities = [...newRussianCities, ... russianCities];
...
// const filterEvenNumbers = numbers.filter(function(numbers2) {
// const resultNumbers2 = numbers2 % 2;
// console.log(resultNumbers2 === 0)
// });
